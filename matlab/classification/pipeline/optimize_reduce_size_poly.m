function N_sounds = optimize_reduce_size_poly(feature_training, Z, database_test, m, th, param)

true_class = database_test(:,end-1);
id_class = unique(true_class);
...
if strcmp(th_type,'f1')
    ...
    while ~stop
        ...
        [posterior_g,computation_time] = identification(database_test, feature_norm, prior_g, param);
...
elseif strcmp(th_type,'time')
    ...
    while ~stop
        ...
        [~,computation_time] = identification(database_test, feature_norm, prior_g, param);
