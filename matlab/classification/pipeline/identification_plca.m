function [posterior_g,computation_time] = identification_plca(database_test, feature_training, prior_g, param)
% Set parameters
n_fft = param.n_fft;
...
for b = 1:n_samples
    ...
    if 20*log10(sum(abs(data).^2)) < threshold
        ...
        [P_s,~] = plca_separation(spectrum_norm',model_size, iter_max, feature_training(:,1:end-2));
