function [L_bay,elapsed_time] = identification_tree(database, tree, param)
...
for b = 1:n_buffer
    ...
    rspectrum_norm = repmat(spectrum_norm,[2,1]);
    aux_decision(cnt) = browse_tree(tree, rspectrum_norm);
