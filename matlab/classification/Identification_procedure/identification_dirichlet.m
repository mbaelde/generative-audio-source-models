function [L_bay,posterior_g] = identification_dirichlet(database, aux_L, prior_g, my_class, param)
% Set parameters
...
for b = 1:N
    ...
    B = sum(gammaln(aux_L_comp)) - gammaln(sum(aux_L_comp));
    L = sum(rspectrum_norm .* aux_L_comp) + B;
